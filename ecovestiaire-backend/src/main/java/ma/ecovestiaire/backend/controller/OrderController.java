...
public class OrderController {
    ...
    @GetMapping("/active")
    public ResponseEntity<OrderResponse> getActiveOrderForItem(@RequestParam("itemId") Long itemId) {
        return ResponseEntity.ok(orderService.getActiveOrderForItem(itemId));
    }
