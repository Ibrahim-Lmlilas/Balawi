...
public class ConversationController {
    ...
    // PUT /api/conversations/messages/{messageId} — Modifier un message
    ...
    public ResponseEntity<MessageResponse> editMessage(
        ...
        MessageResponse response = messageService.editMessage(messageId, newContent);
        return ResponseEntity.ok(response);
    }

    // DELETE /api/conversations/messages/{messageId} — Supprimer un message
