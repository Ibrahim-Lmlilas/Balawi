...
import ma.ecovestiaire.backend.mapper.FavoriteMapper;
...
public class FavoriteServiceImpl implements FavoriteService {
        ...
        private FavoriteItemResponse toFavoriteItemResponse(Item item) {
                ...
                return favoriteMapper.toFavoriteItemResponse(item, likesCount);
        }
        ...
        public void likeItem(Long itemId) {
                ...
                Favorite favorite = favoriteMapper.toEntity(user, item);
