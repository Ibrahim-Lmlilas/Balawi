...
import ma.ecovestiaire.backend.mapper.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentResponse addCommentToItem(Long itemId, CreateCommentRequest request) {
        ...
        Comment comment = commentMapper.toEntity(request.getContent(), item, user);
    ...
    public Page<CommentResponse> getAllComments(Pageable pageable) {
        return getAllComments(false, null, pageable);
    }

    @Override
    @Transactional(readOnly = true)
    public Page<CommentResponse> getAllComments(boolean reportedOnly, String query, Pageable pageable) {
        return commentRepository.findAllWithFilters(reportedOnly, query, pageable)
                .map(this::toCommentResponse);
    }
    ...
    public void deleteComment(Long commentId) {
        ...
        try {
            ...
            // Log error but allow deletion if security is handled by controller/filter
        }
